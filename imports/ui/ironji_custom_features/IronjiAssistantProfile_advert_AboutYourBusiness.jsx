...
export class IronjiAssistantProfile_advert_AboutYourBusiness extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (<div >
            <div style={{ background: "#ebedee", borderRadius: "4px", padding: "5px", width: "99%", border: "1px solid #fff", marginLeft: "1%" }}>
