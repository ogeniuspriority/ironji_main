...
export class Ironji_Trader_Live_LocationBuyer extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        map0.addListener('click', function (event) {
            ...
            google.maps.event.addListener(marker_CLICKED, "drag", function () {
                ...
                document.getElementById("needTransportLatitude").value = pos.lat();
                document.getElementById("needTransportLongitude").value = pos.lng();
            });
        ...
        searchBox.addListener('places_changed', function () {
            ...
            places.forEach(function (place) {
                ...
                document.getElementById("needTransportLatitude").value = place.geometry.location.lat();
                document.getElementById("needTransportLongitude").value = place.geometry.location.lng();
