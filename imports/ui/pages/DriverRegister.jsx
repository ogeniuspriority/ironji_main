    ...
    render() {
        return (<div className="container">
            ...
            <div className="container">
                ...
                <h4 className="signUpTxt_push">DRIVER<br /><span className="minify">Umushoferi</span></h4>
                <div>
                    <form action="" onSubmit={this.registerDriver.bind(this)} method="post">
                        ...
                        <div className="row">
                            ...
                            <div className="col jkly"><input ref="checkInfo" type="checkbox" className="checkbox" name="last_name" placeholder="" required="required" /><span>I certify that the information provided are true</span></div>
                        </div>
