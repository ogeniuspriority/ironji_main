...
class DriverDashboard extends Component {
    ...
    renderThisAccountAvatar() {
        ...
        global.userna_me = "";
        return (<img style={{ width: "150px", height: "150px" }} src={url} />);
    }
    render() {
            ...
            <div className="align-items-center d-flex justify-content-center" style={{ marginLeft: "30%", marginRight: "10%", marginTop: "70px" }}>
                ...
                <div >
                    <div style={{ float: "left", width: "250px", height: "100px" }}>
                        <h4>MainPage</h4>
                        <a href={"/driverMainPage"}><img src={"images/home.png"} style={{ width: "100px", height: "100px" }} /></a>
                    </div>
                    <div style={{ float: "left", width: "250px", height: "100px" }}>
                        <h4>Ironji Wallet</h4>
                ...
                <div style={{ marginTop: "70px" }} >
                    <div style={{ float: "left", width: "250px", height: "100px" }}>
                        ...
                        <a href={"/DriverCarryCargo"}><img src={"images/take_shipment_job.jpg"} style={{ width: "100px", height: "100px" }} /></a>
                    </div>
