...
import { FarmersSendCargoWin0 } from '../farmers_custom/FarmersSendCargoWin0';
import { FarmersSendCargoWin1 } from '../farmers_custom/FarmersSendCargoWin1';
import { FarmersSendCargoWin2 } from '../farmers_custom/FarmersSendCargoWin2';
import { FarmersSendCargoWin3 } from '../farmers_custom/FarmersSendCargoWin3';
import { FarmersSendCargoWin4 } from '../farmers_custom/FarmersSendCargoWin4';

class FarmerSendCargo extends Component {
    constructor(props) {
        super(props);
    }
    componentDidMount() {
    ...
    openNegotiationRoomWin0_hide(param, e) {
        document.getElementById("farmerCarryCargoWin0ChatRoom").style.display = "none";
    }

    
    openNegotiationRoomWin1_hide(param, e) {
        document.getElementById("farmerCarryCargoWin1ChatRoom").style.display = "none";
    }

  
    openNegotiationRoomWin2_hide(param, e) {
        document.getElementById("farmerCarryCargoWin2ChatRoom").style.display = "none";
    }

   
    openNegotiationRoomWin3_hide(param, e) {
        document.getElementById("farmerCarryCargoWin3ChatRoom").style.display = "none";
    }

   
    openNegotiationRoomWin4_hide(param, e) {
        document.getElementById("farmerCarryCargoWin4ChatRoom").style.display = "none";
    }
    render() {
                        ...
                        <div style={{ padding: "5px", height: "auto" }}>
                            <div id="tabWin0" className="modal-content" style={{ marginTop: "5px", padding: "6px" }}>
                                <div style={{ padding: "5px", margin: "5px", borderRadius: "5px", height: "300px", overflowY: "scroll" }}>
                                    <div id="farmerCarryCargoWin0ChatRoom" style={{ display: "none", width: "60%", background: "white", position: "absolute", padding: "6px", borderRadius: "5px", marginTop: "-150px", zIndex: "1000", marginLeft: "50%", border: "1px solid black" }}>
                                        <div style={{ textAlign: "center", padding: "4px", background: "skyblue", borderRadius: "5px", fontSize: "16px" }}>
                                            Negotiation Room
                            ...
                            <div id="tabWin1" className="modal-content" style={{ marginTop: "5px", padding: "6px" }}>
                                <div style={{ padding: "5px", margin: "5px", borderRadius: "5px", height: "300px", overflowY: "scroll" }}>
                                    <div id="farmerCarryCargoWin1ChatRoom" style={{ display: "none", width: "60%", background: "white", position: "absolute", padding: "6px", borderRadius: "5px", marginTop: "-150px", zIndex: "1000", marginLeft: "50%", border: "1px solid black" }}>
                                        <div style={{ textAlign: "center", padding: "4px", background: "skyblue", borderRadius: "5px", fontSize: "16px" }}>
                                            Negotiation Room
                                    ...
                                    <FarmersSendCargoWin1 />

                                </div>
                            </div>
                            <div id="tabWin2" className="modal-content" style={{ marginTop: "5px", padding: "6px" }}>
                                <div style={{ padding: "5px", margin: "5px", borderRadius: "5px", height: "300px", overflowY: "scroll" }}>
                                    <div id="farmerCarryCargoWin2ChatRoom" style={{ display: "none", width: "60%", background: "white", position: "absolute", padding: "6px", borderRadius: "5px", marginTop: "-150px", zIndex: "1000", marginLeft: "50%", border: "1px solid black" }}>
                                        <div style={{ textAlign: "center", padding: "4px", background: "skyblue", borderRadius: "5px", fontSize: "16px" }}>
                                            Negotiation Room
                            ...
                            <div id="tabWin3" className="modal-content" style={{ marginTop: "5px", padding: "6px" }}>
                                <div style={{ padding: "5px", margin: "5px", borderRadius: "5px", height: "300px", overflowY: "scroll" }}>
                                    <div id="farmerCarryCargoWin3ChatRoom" style={{ display: "none", width: "60%", background: "white", position: "absolute", padding: "6px", borderRadius: "5px", marginTop: "-150px", zIndex: "1000", marginLeft: "50%", border: "1px solid black" }}>
                                        <div style={{ textAlign: "center", padding: "4px", background: "skyblue", borderRadius: "5px", fontSize: "16px" }}>
                                            Negotiation Room
                                    ...
                                    <FarmersSendCargoWin3 />

                                </div>
                            </div>
                            <div id="tabWin4" className="modal-content" style={{ marginTop: "5px", padding: "6px" }}>
                                <div style={{ padding: "5px", margin: "5px", borderRadius: "5px", height: "300px", overflowY: "scroll" }}>
                                    <div id="farmerCarryCargoWin4ChatRoom" style={{ display: "none", width: "60%", background: "white", position: "absolute", padding: "6px", borderRadius: "5px", marginTop: "-150px", zIndex: "1000", marginLeft: "50%", border: "1px solid black" }}>
                                        <div style={{ textAlign: "center", padding: "4px", background: "skyblue", borderRadius: "5px", fontSize: "16px" }}>
                                            Negotiation Room
